 ...
 */
export function hasAnyBone(boneNames: string[], group: readonly string[]): boolean {
...
export function getBoneAliases(canonicalName: string): string[] {
  const aliases: Record<string, string[]> = {
    ...
    [BONE_NAMES.LEFT_UPPER_LEG]: [BONE_NAMES.LEFT_HIND_UPPER, BONE_NAMES.LEFT_HIND_LEG],
    [BONE_NAMES.RIGHT_UPPER_LEG]: [BONE_NAMES.RIGHT_HIND_UPPER, BONE_NAMES.RIGHT_HIND_LEG],
 ...
 */
export function hasBoneWithAliases(boneNames: string[], targetName: string): boolean {
